 ...
 * @author IVAN
 */
public class FrmAsignarActivo extends javax.swing.JFrame {

    INegocio negocio;
    private List<Persona> listaPersonas;
    private Activo activo;

    public FrmAsignarActivo(Activo activo, List<Persona> personas) {
    ...
    public void editarActivo() {
        // Obtener el responsable seleccionado del combo
        Persona nuevoResponsable = (Persona) cmbPersonas.getSelectedItem();

        // Verificar que se seleccionó un responsable
        ...
        // Llamar al método de negocio para editar el activo
        if (negocio.editarActivo(activoActualizado)) {
            JOptionPane.showMessageDialog(null, "Responsable asignado exitosamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(null, "Error al asignar el responsable.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Asignar activo ");
        ...
        btnEditar.setText("Asignar activo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAsignarActivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //  new FrmAsignarActivo().setVisible(true);
            }
        });
    }
