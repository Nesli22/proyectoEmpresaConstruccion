 ...
 * @author Rodrigo Gtz
 */
public class FrmBuscarActivo extends javax.swing.JFrame {

    INegocio negocio;

    public FrmBuscarActivo() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuscarActivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuscarActivo().setVisible(true);
            }
        });
    }
    ...
    private void buscarActivos() {
        ...
        new Thread(() -> {
            try {
                ...
                Logger.getLogger(FrmBuscarActivo.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    if (filaSeleccionada != -1) { // Si hay una fila seleccionada
        ...
        FrmAsignarActivo frmAsignar = new FrmAsignarActivo(activo,personas);
        dispose();
        frmAsignar.setVisible(true);
    } else {
