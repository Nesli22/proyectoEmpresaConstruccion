...
public class FrmProgramarMantenimiento extends javax.swing.JFrame {
    ...
    if (filaSeleccionada != -1) { // Si hay una fila seleccionada
        ...
        FrmAsignarMantenimiento frmAsignarMantenimiento = new FrmAsignarMantenimiento(activo);
        dispose();
        frmAsignarMantenimiento.setVisible(true);
    } else {
        JOptionPane.showMessageDialog(this, "Por favor, selecciona un activo para programar el mantenimiento.");
    }
}
